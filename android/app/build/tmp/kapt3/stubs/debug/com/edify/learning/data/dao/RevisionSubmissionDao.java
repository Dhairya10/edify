...
public abstract interface RevisionSubmissionDao {
    ...
    @androidx.room.Query(value = "UPDATE revision_submissions SET gemmaFeedback = :feedback, isEvaluated = :isEvaluated, evaluatedAt = :evaluatedAt WHERE id = :submissionId")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object updateSubmissionEvaluation(long submissionId, @org.jetbrains.annotations.NotNull()
    java.lang.String feedback, boolean isEvaluated, long evaluatedAt, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> $completion);
