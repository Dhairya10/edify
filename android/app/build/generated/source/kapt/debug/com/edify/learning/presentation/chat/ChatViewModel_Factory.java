...
public final class ChatViewModel_Factory implements Factory<ChatViewModel> {
  ...
  public ChatViewModel get() {
    return newInstance(repositoryProvider.get(), questRepositoryProvider.get(), userProfileRepositoryProvider.get(), chatResponseServiceProvider.get(), contextProvider.get());
  }
  ...
  public static ChatViewModel_Factory create(Provider<LearningRepository> repositoryProvider,
      ...
      Provider<ChatResponseService> chatResponseServiceProvider,
      Provider<Context> contextProvider) {
    return new ChatViewModel_Factory(repositoryProvider, questRepositoryProvider, userProfileRepositoryProvider, chatResponseServiceProvider, contextProvider);
  }
  ...
  public static ChatViewModel newInstance(LearningRepository repository,
      ...
      ChatResponseService chatResponseService, Context context) {
    return new ChatViewModel(repository, questRepository, userProfileRepository, chatResponseService, context);
  }
}
