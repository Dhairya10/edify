  ...
  public GeneratedQuestDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfGeneratedQuest = new EntityInsertionAdapter<GeneratedQuest>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `generated_quests` (`id`,`chapterId`,`subjectName`,`title`,`question`,`userId`,`isCompleted`,`userAnswer`,`completedAt`,`createdAt`) VALUES (?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getUserAnswer() == null) {
          ...
          statement.bindString(8, entity.getUserAnswer());
        }
    ...
    this.__updateAdapterOfGeneratedQuest = new EntityDeletionOrUpdateAdapter<GeneratedQuest>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `generated_quests` SET `id` = ?,`chapterId` = ?,`subjectName` = ?,`title` = ?,`question` = ?,`userId` = ?,`isCompleted` = ?,`userAnswer` = ?,`completedAt` = ?,`createdAt` = ? WHERE `id` = ?";
      }
      ...
      public List<GeneratedQuest> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new GeneratedQuest(_tmpId,_tmpChapterId,_tmpSubjectName,_tmpTitle,_tmpQuestion,_tmpUserId,_tmpIsCompleted,_tmpUserAnswer,_tmpCompletedAt,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public GeneratedQuest call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new GeneratedQuest(_tmpId,_tmpChapterId,_tmpSubjectName,_tmpTitle,_tmpQuestion,_tmpUserId,_tmpIsCompleted,_tmpUserAnswer,_tmpCompletedAt,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
