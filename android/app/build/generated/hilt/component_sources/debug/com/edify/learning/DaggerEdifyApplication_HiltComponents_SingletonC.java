...
import com.edify.learning.di.DatabaseModule_ProvideQuestServiceFactory;
...
public final class DaggerEdifyApplication_HiltComponents_SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new QuestViewModel(singletonCImpl.questRepositoryProvider.get());

          case 7: // com.edify.learning.presentation.revision.RevisionViewModel 
          return (T) new RevisionViewModel(singletonCImpl.learningRepositoryProvider.get(), singletonCImpl.questRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends EdifyApplication_HiltComponents.SingletonC {
    ...
    private Provider<QuestService> provideQuestServiceProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideQuestServiceProvider = DoubleCheck.provider(new SwitchingProvider<QuestService>(singletonCImpl, 4));
      this.questRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<QuestRepository>(singletonCImpl, 3));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new LearningRepository(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.subjectDao(), singletonCImpl.chapterDao(), singletonCImpl.noteDao(), singletonCImpl.chatDao(), singletonCImpl.userResponseDao(), singletonCImpl.provideGemmaServiceProvider.get());
          ...
          case 3: // com.edify.learning.data.repository.QuestRepository 
          return (T) new QuestRepository(singletonCImpl.chapterStatsDao(), singletonCImpl.userProfileDao(), singletonCImpl.chapterDao(), singletonCImpl.subjectDao(), singletonCImpl.provideQuestServiceProvider.get());

          case 4: // com.edify.learning.data.service.QuestService 
          return (T) DatabaseModule_ProvideQuestServiceFactory.provideQuestService(singletonCImpl.chapterDao(), singletonCImpl.provideGemmaServiceProvider.get());
