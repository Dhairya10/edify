...
public final class DaggerEdifyApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends EdifyApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.questScoringViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 5);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new ChapterViewModel(singletonCImpl.learningRepositoryProvider.get(), singletonCImpl.questRepositoryProvider.get());

          case 1: // com.edify.learning.presentation.chat.ChatViewModel 
          return (T) new ChatViewModel(singletonCImpl.learningRepositoryProvider.get(), singletonCImpl.questRepositoryProvider.get(), ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
          ...
          return (T) new HomeViewModel(singletonCImpl.learningRepositoryProvider.get());
          ...
          case 5: // com.edify.learning.presentation.developer.QuestScoringViewModel 
          return (T) new QuestScoringViewModel(singletonCImpl.questScoringServiceProvider.get());

          case 6: // com.edify.learning.presentation.quest.QuestViewModel 
          ...
          case 7: // com.edify.learning.presentation.revision.RevisionViewModel 
  ...
  private static final class SingletonCImpl extends EdifyApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideQuestGenerationServiceProvider = DoubleCheck.provider(new SwitchingProvider<QuestGenerationService>(singletonCImpl, 3));
      this.learningRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<LearningRepository>(singletonCImpl, 0));
      this.questRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<QuestRepository>(singletonCImpl, 4));
      this.questScoringServiceProvider = DoubleCheck.provider(new SwitchingProvider<QuestScoringService>(singletonCImpl, 5));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) DatabaseModule_ProvideGemmaServiceFactory.provideGemmaService(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 3: // com.edify.learning.data.service.QuestGenerationService 
          return (T) DatabaseModule_ProvideQuestGenerationServiceFactory.provideQuestGenerationService(singletonCImpl.chapterStatsDao(), singletonCImpl.generatedQuestDao(), singletonCImpl.chapterDao(), singletonCImpl.noteDao(), singletonCImpl.chatDao(), singletonCImpl.subjectDao(), singletonCImpl.provideGemmaServiceProvider.get());

          case 4: // com.edify.learning.data.repository.QuestRepository 
          ...
          case 5: // com.edify.learning.domain.service.QuestScoringService 
