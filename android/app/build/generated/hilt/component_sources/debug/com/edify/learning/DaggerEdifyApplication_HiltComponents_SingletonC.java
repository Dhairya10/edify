...
public final class DaggerEdifyApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends EdifyApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return ImmutableSet.<String>of(ChapterViewModel_HiltModules_KeyModule_ProvideFactory.provide(), ChatViewModel_HiltModules_KeyModule_ProvideFactory.provide(), HomeViewModel_HiltModules_KeyModule_ProvideFactory.provide(), NotesViewModel_HiltModules_KeyModule_ProvideFactory.provide(), SubjectViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends EdifyApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.subjectViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 4);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return ImmutableMap.<String, Provider<ViewModel>>of("com.edify.learning.presentation.chapter.ChapterViewModel", ((Provider) chapterViewModelProvider), "com.edify.learning.presentation.chat.ChatViewModel", ((Provider) chatViewModelProvider), "com.edify.learning.presentation.home.HomeViewModel", ((Provider) homeViewModelProvider), "com.edify.learning.presentation.notes.NotesViewModel", ((Provider) notesViewModelProvider), "com.edify.learning.presentation.subject.SubjectViewModel", ((Provider) subjectViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new ChapterViewModel(singletonCImpl.learningRepositoryProvider.get());

          case 1: // com.edify.learning.presentation.chat.ChatViewModel 
          return (T) new ChatViewModel(singletonCImpl.learningRepositoryProvider.get());

          case 2: // com.edify.learning.presentation.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.learningRepositoryProvider.get());

          case 3: // com.edify.learning.presentation.notes.NotesViewModel 
          return (T) new NotesViewModel(singletonCImpl.learningRepositoryProvider.get());

          case 4: // com.edify.learning.presentation.subject.SubjectViewModel 
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new LearningRepository(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.subjectDao(), singletonCImpl.chapterDao(), singletonCImpl.noteDao(), singletonCImpl.chatDao(), singletonCImpl.provideGemmaServiceProvider.get());
