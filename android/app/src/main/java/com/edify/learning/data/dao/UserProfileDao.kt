...
interface UserProfileDao {
    ...
    @Query("UPDATE user_profile SET name = :name, languagePreference = :language, hasCompletedOnboarding = :completed, updatedAt = :timestamp WHERE userId = :userId")
    suspend fun updateOnboardingInfo(userId: String, name: String, language: String, completed: Boolean, timestamp: Long = System.currentTimeMillis())
}
